...
public class TestDBScan {
	...
	public static void plot_clusterData(double [][] orgData, ArrayList<double [][]> clusterData, ArrayList<double [][]> noise) {
		...
		String [] titles    = new String [2];
	 	...
	 	titles[1] = "      DBScan Clustered Data";
	 	yLabels[0] = "x2";
	 	yLabels[1] = yLabels[0];
	 	xLabels[0] = "x1";
	 	xLabels[1] = xLabels[0];
